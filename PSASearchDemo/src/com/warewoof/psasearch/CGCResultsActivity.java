...
public class CGCResultsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.main_results_cgc);
		...
		searchArgs = "http://www.cgccomics.com/grading/verify-cgc-comic.aspx?cgc-comic-cert=" + searchArgs;
		...
		resultsView.setWebViewClient(new WebViewClient() {
			...
			public void onPageFinished(WebView view, String url) {
				...
				resultsView.loadUrl("javascript:(function() { " + "document.getElementById('pager').getElementsByTagName('table')[0].style.display = 'none';" +"})()");
				resultsView.loadUrl("javascript:(function() { " +"document.getElementsByClassName('fatFooterFull')[0].style.display = 'none';" +"})()");
				resultsView.loadUrl("javascript:(function() { " +"document.getElementsByClassName('footerLogosFull')[0].style.display = 'none';" +"})()");
